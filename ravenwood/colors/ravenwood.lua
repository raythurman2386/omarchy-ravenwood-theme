-- Ravenwood Dark Theme for Neovim
-- A custom colorscheme matching the Omarchy Ravenwood theme
-- Palette: Emerald forest with warm cream text
...
function M.setup()
	...
	set_hl("DiffAdd", { bg = "#1e3a2f" })
	set_hl("DiffChange", { bg = "#1e2f3a" })
	set_hl("DiffDelete", { bg = "#3a1e1e" })
	set_hl("DiffText", { bg = "#2a4a3f" })
	...
	set_hl("DiagnosticVirtualTextError", { fg = colors.red, bg = "#2a1e1e" })
	set_hl("DiagnosticVirtualTextWarn", { fg = colors.yellow, bg = "#2a261e" })
	set_hl("DiagnosticVirtualTextInfo", { fg = colors.blue, bg = "#1e262a" })
	set_hl("DiagnosticVirtualTextHint", { fg = colors.cyan, bg = "#1e2a26" })
	...
	set_hl("GitSignsAddLn", { bg = "#1e3a2f" })
	set_hl("GitSignsChangeLn", { bg = "#1e2f3a" })
	set_hl("GitSignsDeleteLn", { bg = "#3a1e1e" })
	...
	set_hl("@text.diff.add", { bg = "#1e3a2f" })
	set_hl("@text.diff.delete", { bg = "#3a1e1e" })
